...
# Project:  test2.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile test2.pro
#############################################################################
...
INCPATH       = -I. -I/usr/local/qwt-6.1.1/include -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I. -I. -I/usr/lib/qt/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = test21.0.0
DISTDIR = /home/roman/Desktop/exCiton_v0.3/.tmp/test21.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -L/usr/local/qwt-6.1.1/lib -lqwt -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = main.cpp \
		...
		physics.cpp \
		modeling.cpp \
		help_file.cpp moc_mainwindow.cpp \
		moc_modeling.cpp
OBJECTS       = main.o \
		mainwindow.o \
		physics.o \
...
Makefile: test2.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile test2.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h physics.h modeling.h help_file.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp physics.cpp modeling.cpp help_file.cpp $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_mainwindow.cpp moc_modeling.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_modeling.cpp
moc_mainwindow.cpp: physics.h \
		/usr/local/qwt-6.1.1/include/qwt_plot.h \
		/usr/local/qwt-6.1.1/include/qwt_global.h \
		/usr/local/qwt-6.1.1/include/qwt_text.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_dict.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_item.h \
		/usr/local/qwt-6.1.1/include/qwt_legend_data.h \
		/usr/local/qwt-6.1.1/include/qwt_graphic.h \
		/usr/local/qwt-6.1.1/include/qwt_null_paintdevice.h \
		/usr/local/qwt-6.1.1/include/qwt_scale_map.h \
		/usr/local/qwt-6.1.1/include/qwt_transform.h \
		/usr/local/qwt-6.1.1/include/qwt_interval.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_grid.h \
		/usr/local/qwt-6.1.1/include/qwt_scale_div.h \
		/usr/local/qwt-6.1.1/include/qwt_legend.h \
		/usr/local/qwt-6.1.1/include/qwt_abstract_legend.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_curve.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_seriesitem.h \
		/usr/local/qwt-6.1.1/include/qwt_series_data.h \
		/usr/local/qwt-6.1.1/include/qwt_samples.h \
		/usr/local/qwt-6.1.1/include/qwt_point_3d.h \
		/usr/local/qwt-6.1.1/include/qwt_point_polar.h \
		/usr/local/qwt-6.1.1/include/qwt_math.h \
		/usr/local/qwt-6.1.1/include/qwt_series_store.h \
		/usr/local/qwt-6.1.1/include/qwt_symbol.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_magnifier.h \
		/usr/local/qwt-6.1.1/include/qwt_magnifier.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_panner.h \
		/usr/local/qwt-6.1.1/include/qwt_panner.h \
		/usr/local/qwt-6.1.1/include/qwt_plot_picker.h \
		/usr/local/qwt-6.1.1/include/qwt_picker.h \
		/usr/local/qwt-6.1.1/include/qwt_event_pattern.h \
		/usr/local/qwt-6.1.1/include/qwt_picker_machine.h \
		/usr/local/qwt-6.1.1/include/qwt_scale_draw.h \
		/usr/local/qwt-6.1.1/include/qwt_abstract_scale_draw.h \
		modeling.h \
		mainwindow.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I/home/roman/Desktop/exCiton_v0.3 -I/usr/local/qwt-6.1.1/include -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/5.1.0 -I/usr/include/c++/5.1.0/x86_64-unknown-linux-gnu -I/usr/include/c++/5.1.0/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.1.0/include-fixed -I/usr/include mainwindow.h -o moc_mainwindow.cpp

moc_modeling.cpp: modeling.h
	/usr/lib/qt/bin/moc $(DEFINES) -I/usr/lib/qt/mkspecs/linux-g++ -I/home/roman/Desktop/exCiton_v0.3 -I/usr/local/qwt-6.1.1/include -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/5.1.0 -I/usr/include/c++/5.1.0/x86_64-unknown-linux-gnu -I/usr/include/c++/5.1.0/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/5.1.0/include-fixed -I/usr/include modeling.h -o moc_modeling.cpp
...
modeling.o: modeling.cpp modeling.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modeling.o modeling.cpp

help_file.o: help_file.cpp help_file.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o help_file.o help_file.cpp

moc_mainwindow.o: moc_mainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_mainwindow.o moc_mainwindow.cpp

moc_modeling.o: moc_modeling.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_modeling.o moc_modeling.cpp
